      ...
      <div className="lay">
        <section className="row footer-header">
          ...
          <section className="col-12 col-desksm-4 col-desk-3 footer-header__redes">
            ...
            <a href="https://www.instagram.com/lanacioncom/" target="_blank"><i
              className="icon-instagram"></i></a>
            <a href="http://servicios.lanacion.com.ar/herramientas/rss/ayuda" target="_blank"><i
          ...
          <section className="col-12 col-desksm-4 col-desk-3 footer-header__app">
            <a href="https://play.google.com/store/apps/details?id=app.lanacion.activity&amp;hl=es_419"
              target="_blank" className="app_play">
        ...
        <section className="row footer-sitio">
          <section className="col-desksm-9 col-deskxl-8 footer-sitio__links">
            <a href="http://especiales.lanacion.com.ar/varios/mapa-sitio/index.html" className="item_link">Mapa
                    del sitio</a>
            ...
            <a href="https://suscripciones.lanacion.com.ar/suscribirme/" className="item_link">Suscribirse al
                    diario impreso</a>
          </section>
          <section className="col-desksm-3 col-deskxl-4 footer-sitio__captcha">
            <p>
              Protegido por re CAPTCHA:
                    <a href="https://policies.google.com/terms?hl=es-419" target="_blank"
                className="condition">Condiciones</a>
              <a href="https://policies.google.com/privacy?hl=es-419" target="_blank"
                className="private">Privacidad</a>
            </p>
            {/* <!--
          ...
          <section className="col-desksm-6 col-desk-6 footer-copyright__fiscal">
            <p>
              <img src="https://static.glanacion.com/v2/ln/img/gda.jpg" alt="gda" className="img_gda" />
                ...
                target="_blank"><img src="https://static.glanacion.com/v2/ln/img/data.jpg"
                  alt="Data fiscal" className="img_data-fiscal" /></a>
            </p>
